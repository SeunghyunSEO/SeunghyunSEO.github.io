...
<center>$$Pr(\theta \mid x_{1...I})=\fraq{Pr(x_{1...I} \mid \theta)Pr(\theta}{Pr(x_{1...I})}$$</center>

<center>$$\hat{\Theta}=argmax_\theta[\fraq{Pr(x_{1...I} \mid \theta)Pr(\theta}{Pr(x_{1...I})}]$$</center>

<center>$$\hat{\Theta}=argmax_\theta[\fraq{\prod_{i=1}^{I}Pr(x_i \mid \theta)Pr(\theta}{Pr(x_{1...I})}]$$</center>
