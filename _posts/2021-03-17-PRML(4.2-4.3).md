...
#### <mark style='background-color: #dcffe4'>  \\( {\bf \pi} \\) 구하기 </mark>

\\( \pi \\) 구하기 위해 로그 가능도 함수를 \\( \pi \\) 에 대해 미분하여 관련된 항목만 모으면 다음과 같아진다.
...
#### <mark style='background-color: #dcffe4'>  \\( {\bf \mu} \\) 구하기 </mark>
