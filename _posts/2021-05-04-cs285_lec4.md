...
### <mark style='background-color: #dcffe4'> Markov Decision Process (MDP) </mark>

그럼 한번 MDP에 대한 Full formal definition을 빌드업 하도록 하겠습니다.
...
### <mark style='background-color: #dcffe4'> Markov Process Examples </mark>

***

Markov Chain, MDP, MRP에 대해서 추가 자료를 조금 첨부해 보도록 하겠습니다.
...
## <mark style='background-color: #fff5b1'> The Objective for Reinforcement Learning </mark>
...
![maze](/assets/images/CS285/lec-4/maze.png){: width="40%"}
*Additive Fig.*
...
우리는 지금 State와 Action을 묶어서 생각하는 Augmented Markov Chain을 생각하기로 했기 때문에 `S1,S2,S3,S4` 4차원의 State Space와, `상,하,좌,우`로 움직일 수 있는 마찬가지로 4차원의 Action Space가 있다면 $$p(s_t,a_t)$$는 $$4\times4$$로 16차원이 되고, 이에 따라 Transition Probability $$T$$도 $$\mathbb{R}^{4 \times 4 \times 4}$$의 3차원 행렬인 Tensor가 됩니다.
...
### <mark style='background-color: #dcffe4'> Finite Horizon Case </mark>
...
### <mark style='background-color: #dcffe4'> Infinite Horizon Case </mark>
...
### <mark style='background-color: #dcffe4'> Why Expectations matter in RL </mark>
...
### <mark style='background-color: #dcffe4'> The Anatomy of a RL Algorithm </mark>
...
즉 모든 action을 테스트해보고 100프로 확률로 그걸 고를 수 있습니다.
...
### <mark style='background-color: #dcffe4'> Q-Function and Value Function</mark>
...
### <mark style='background-color: #dcffe4'> Model-based RL </mark>
...
### <mark style='background-color: #dcffe4'> Value-based RL </mark>
...
### <mark style='background-color: #dcffe4'> Policy-based RL </mark>
...
### <mark style='background-color: #dcffe4'> Advanced Policy-based (or Policy+Value) RL </mark>
...
### <mark style='background-color: #dcffe4'> Comparison 1 : Sample Efficiency </mark>
...
### <mark style='background-color: #dcffe4'> Comparison 2 : Stability and Ease of Use </mark>

![slide38](/assets/images/CS285/lec-4/slide38.png)
*Slide. 38.*

`Stability & Ease of Use`는 알고리즘이 수렴을 하는가? 에 관한 지표(?)입니다. 
...
### <mark style='background-color: #dcffe4'> Comparison 3 : Assumptions </mark>
...
해당 예제들의 비디오들을 따로 이 글에 첨부하지 않을 것이므로 궁금하신 분들은 ([Lecture 4, part 6](https://www.youtube.com/watch?v=hfj9mS3nTLU&list=PL_iWQOsE6TfURIIhCrlt-wj9ByIVpbfGc&index=20))을 보시면 될 것 같습니다.
...
위의 설명한 예제들은 추후에 관련 알고리즘들을 깊게 설명하면서 다시 소개한다고 하면서 강화학습의 기본에 대한 강의는 여기서 끝납니다.
