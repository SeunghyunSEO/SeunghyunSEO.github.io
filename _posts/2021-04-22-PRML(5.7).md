...
*Additive Fig. prior와 likelihood를 곱해 얻은 posterior를 최대화 하는 MAP 솔루션은 데이터 샘플 수가 많으면 MLE 솔루션과 같아진다 (점이 됨).*
...
![uncertainty1](/assets/images/PRML_5.7/uncertainty1.png)
*Additive Fig.*
...
![net](/assets/images/PRML_5.7/net.png)
*Additive Fig.*


![net](/assets/images/PRML_5.7/gp_net.png)
*Additive Fig.*


![net](/assets/images/PRML_5.7/do_net.png)
*Additive Fig.*
