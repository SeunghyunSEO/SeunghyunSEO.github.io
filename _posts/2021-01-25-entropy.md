...
![image](https://user-images.githubusercontent.com/48202736/105872548-e1a6ab00-603d-11eb-80d3-0cbf5874b534.png){: width="50%"}
...
![image](https://user-images.githubusercontent.com/48202736/105871656-dc952c00-603c-11eb-91f8-5336c51850d6.png)
...
![image](https://user-images.githubusercontent.com/48202736/105877523-71028d00-6043-11eb-820d-be6011d28bd2.png)

만약 x의 값이 이미 알려져 있다면, 그에 해당하는 y값을 알기 위해 필요한 정보는 $$-lnp(y \mid x)$$로 주어집니다. 

![image](https://user-images.githubusercontent.com/48202736/105877409-4f090a80-6043-11eb-814b-22b19328af8f.png)
...
![image](https://user-images.githubusercontent.com/48202736/105885200-2afdf700-604c-11eb-9610-e3d6b7f71b55.png)
...
![image](https://user-images.githubusercontent.com/48202736/105942339-63c8bb00-60a2-11eb-951e-a8113e8ca3d7.png)
...
- <mark style='background-color: #dcffe4'> KLD 머신러닝이 분포를 추정하는 것 과의 관계 </mark>
...
![image](https://user-images.githubusercontent.com/48202736/105885384-6b5d7500-604c-11eb-958b-62384567ba81.png)
...
- <mark style='background-color: #fff5b1'> Cross Entropy and KLD </mark>

tmp

- <mark style='background-color: #fff5b1'> Variational Inference in Bayesian Approach </mark>
...
<center>$$ KL(q_{\theta}(\phi) \parellel p(\phi \mid X,W) = \int q_{\theta}(\phi) log \frac{ q_{\theta}(\phi) }{ p(\phi \mid X,W) } ) d\phi $$</center>
...
최종적으로 이렇게 해서 구한 $$q_{\theta}(\phi)$$ 를 통해 우리는 Inference를 하게 되는 것입니다.
