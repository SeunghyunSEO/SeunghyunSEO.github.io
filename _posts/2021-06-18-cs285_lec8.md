...
![discrete_vs_continuous1](/assets/images/CS285/lec-8/discrete_vs_continuous1.png)
*Fig. Discrete Action Space vs Continuous Action Space 1*

![discrete_vs_continuous2](/assets/images/CS285/lec-8/discrete_vs_continuous2.png)
*Fig. Discrete Action Space vs Continuous Action Space 2*
...
마지막 옵션은 approximate maximizer를 학습하는 방법으로 [Continuous control with deep reinforcement learning](https://arxiv.org/pdf/1509.02971) 라는 논문에서 소개된 방법입니다. 
...
![naf_flowchart](/assets/images/CS285/lec-8/naf_flowchart.png)
*Fig. NAF Flowchart*
