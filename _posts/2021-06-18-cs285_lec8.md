...
그러니까 MSE Loss를 쓰는 회귀문제에서 target이 움직이는거나 다름 없기 때문에 네트워크가 수렴하기 어렵습니다.

![slide10](/assets/images/CS285/lec-8/slide10.png)
*Slide. 10.*

그렇기 때문에 우리는 Q-Learning에 `어떤 Target Network`라고 하는 것을 사용해서 Full Batch Fitted Q-Learning과 Online Q-Learning을 결합한(?) 방법을 써보려고 합니다.
