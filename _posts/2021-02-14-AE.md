...
Test Time, 즉, 추론 시에는 당연히 여러개의 (지금은 $$1024$$) 이산적인 샘플 (discrete sample)을 독립적으로 샘플링 해서 사용할 수도 있고, 처음 $$z_1$$을 뽑고, $$z_1을 통해 $z_2$를 뽑고... 이런식으로 반복해서 서로 독립적이지 않은 연관된 샘플 시퀀스를 뽑을 수 있습니다.
