...
*Fig. 학습 시에는 prior를 고정하고 VQ-VAE를 학습한다.*


Test Time에만 $$z$$에 대한 Autoregressive Distribution을 사용해서 점진적인 샘플링을 통해서 x를 만들어 낸다고 합니다. 그리고 prior와 VQ-VAE를 동시에 (jointly) 학습하는 것은 future work로 남겨둔다고 하네요. 

![vqvae_slide_example3](/assets/images/ae_to_vae/vqvae_slide_example3.png)
*Fig. 추론 시에는 prior sample을 Autoregressive하게 만들어서 사용한다.*

![vqvae_slide_example7](/assets/images/ae_to_vae/vqvae_slide_example7.png){: width="80%"}
*Fig. prior sample을 Autoregressive하게 만들어서 사용함은 물론이고 Decoder까지 Autoregressive하게 구성했다.*
...
![vqvae_figure2](/assets/images/ae_to_vae/vqvae_figure2.png)
![vqvae_figure3](/assets/images/ae_to_vae/vqvae_figure3.png)
![vqvae_figure4](/assets/images/ae_to_vae/vqvae_figure4.png)
![vqvae_figure5](/assets/images/ae_to_vae/vqvae_figure5.png)
![vqvae_figure7](/assets/images/ae_to_vae/vqvae_figure7.png)
