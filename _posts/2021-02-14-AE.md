---
title: (미완)From AutoEncoder (AE) to Variational AutoEncoders (VAEs)
...
### <mark style='background-color: #dcffe4'> Why do we have to learn deterministic function, x=f(z) ? </mark>
