...
![cs285_lec17_latent1](/assets/images/ae_to_vae/cs285_lec17_latent1.png){: width="60%"}
*Fig.*
...
![cs285_lec17_pxz1](/assets/images/ae_to_vae/cs285_lec17_pxz1.png)
*Fig.*

![cs285_lec17_pxz2](/assets/images/ae_to_vae/cs285_lec17_pxz2.png)
*Fig.*
...
- Maximum likelihood fit : $$ \begin{aligned} \theta \leftarrow argmax_{\theta} \frac{1}{N} \sum_i log p_{\theta} (x_i)  \\ \theta \leftarrow argmax_{\theta} \frac{1}{N} \sum_i log ( \int p_{\theta}(x_i \vert z) p(z) dz ) \end{aligned}$$
...
![cs285_lec18_vae3](/assets/images/ae_to_vae/cs285_lec18_vae3.png)
*Fig.*
