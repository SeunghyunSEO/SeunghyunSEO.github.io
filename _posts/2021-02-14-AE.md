...
![jd_prob1](/assets/images/ae_to_vae/jd_prob1.png){: width="70%"}
...
여기서 과연 $$p(x_i \vert z)$$ 분포는 무엇인지, 그리고 이는 어떻게 계산할 것인지? 가 관건입니다.
...
이 때 자주 쓰이는 방법이 바로 지금 우리가 논하려고 하는 VAE에서도 쓰는 방법인 `변분 추론 (variational Inference)`이 됩니다.
