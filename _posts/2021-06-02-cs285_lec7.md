...
요약하자면 Value Iteration 에 대해서는 optimal value로 반복적인 연산을 하면 다가가는게 보장되어 있지만, 뉴럴 네트워크를 Supervised Learning으로 피팅하는 Fitted Value Iteration 은 보장되어 있지 않다는 겁니다. (하지만 practical하게는 optimal value에 근접한 값을 얻어낼 수는 있다고 합니다.) 
