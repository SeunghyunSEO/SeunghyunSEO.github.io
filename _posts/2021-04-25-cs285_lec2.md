...
![additive_fig_10](/assets/images/CS285/lec-2/additive_fig_10.png){: width="50%"}
*Additive Fig.*
...
![additive_fig_11](/assets/images/CS285/lec-2/additive_fig_11.png){: width="50%"}
*Additive Fig.*
...
![additive_fig_12](/assets/images/CS285/lec-2/additive_fig_12.png){: width="50%"}
*Additive Fig.*
...
마지막으로 생각해 볼 `Autoregressive Discretization`는 매우 간단한 `Output Mixture of Gaussians)`와 복잡한 `Latent Variable Model`의 중간 정도의 난이도와 표현력을 가지는 방법론인데,
