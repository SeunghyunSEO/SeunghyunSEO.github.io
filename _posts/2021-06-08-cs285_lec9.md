...
주의할 점은 여전히 state,$$s_t$$는 $$\pi_{\thata'}$$의 정책에서 샘플링되고 있고 $$(a_t \vert s_t)$$만 $$\theta$$로 부터 샘플링 되고 있다는 겁니다.
근데 여기서 하나 남은 문제점이 있는데요 $$\pi_{\thata'}$$가 뭔지 아직 모르는 상태에서 state를 샘플링 할 수 있을까요? 아닙니다.
