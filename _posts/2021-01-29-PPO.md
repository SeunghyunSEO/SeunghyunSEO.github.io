...
<center>$$ \hat{g} = \hat{\mathbb{E}_t} [ \bigtriangledown_{\theta} log \pi_{\theta} (a_t \mid s_t) \hat{{A}_t}  ] $$</center>
  
<center>$$ L^{PG}(\theta) = \hat{\mathbb{E}_t} [ log \pi_{\theta} (a_t \mid s_t) \hat{{A}_t}  ] $$</center>
  
- <mark style='background-color: #dcffe4'> Trust Region Methods </mark>

<center>$$ maximize_{\theta} \hat{\mathbb{E}_t} [ \frac{\pi_{\theta} (a_t \mid s_t)}{\pi_{\theta_{old}} (a_t \mid s_t)} \hat{{A}_t}  ] $$</center>

<center>$$ subject \space to \space \hat{\mathbb{E}_t}[ KL[ \pi_{\theta_{old}}(\cdot \mid s_t), \pi_{\theta}(\cdot \mid s_t) ] ] \leq \delta $$</center>


<center>$$ maximize_{\theta} \hat{\mathbb{E}_t} [ \frac{\pi_{\theta} (a_t \mid s_t)}{\pi_{\theta_{old}} (a_t \mid s_t)} \hat{{A}_t} - \beta KL[ \pi_{\theta_{old}}(\cdot \mid s_t), \pi_{\theta}(\cdot \mid s_t) ] ] $$</center>
...
<center>$$ L^{CPI}(\theta) = \hat{\mathbb{E}_t} [ \frac{\pi_{\theta} (a_t \mid s_t)}{\pi_{\theta_{old}} (a_t \mid s_t)} \hat{{A}_t}  ] = \hat{\mathbb{E}_t} [r_t(\theta) \hat{A_t}] $$</center>


<img width="1117" alt="스크린샷 2021-01-28 오후 3 02 18" src="https://user-images.githubusercontent.com/48202736/106097078-0607a200-617a-11eb-96d4-041ead10d199.png">

<img width="1132" alt="스크린샷 2021-01-28 오후 3 01 57" src="https://user-images.githubusercontent.com/48202736/106097082-07d16580-617a-11eb-9237-45e82aac77e3.png">
...
<img width="1126" alt="스크린샷 2021-01-28 오후 3 02 38" src="https://user-images.githubusercontent.com/48202736/106097092-0acc5600-617a-11eb-84da-5d5a6723e4d4.png">


- <mark style='background-color: #fff5b1'> 6. Experiments </mark>

<img width="1111" alt="스크린샷 2021-01-28 오후 3 02 47" src="https://user-images.githubusercontent.com/48202736/106097096-0bfd8300-617a-11eb-8b37-087cb9db2016.png">

<img width="1128" alt="스크린샷 2021-01-28 오후 3 02 56" src="https://user-images.githubusercontent.com/48202736/106097100-0c961980-617a-11eb-8567-a4fe1703b510.png">

<img width="901" alt="스크린샷 2021-01-28 오후 3 03 02" src="https://user-images.githubusercontent.com/48202736/106097105-0dc74680-617a-11eb-9cef-c7b2a267e2b1.png">

<img width="1126" alt="스크린샷 2021-01-28 오후 3 03 08" src="https://user-images.githubusercontent.com/48202736/106097106-0ef87380-617a-11eb-869a-15949481cf24.png">

<img width="1111" alt="스크린샷 2021-01-28 오후 3 03 15" src="https://user-images.githubusercontent.com/48202736/106097109-1029a080-617a-11eb-80ef-be3a98556628.png">
