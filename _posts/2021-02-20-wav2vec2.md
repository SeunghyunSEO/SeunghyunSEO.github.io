...
글의 말미에 다루게 될 핵심적인 내용인 Wav2Vec2.0 논문의 중요 포인트는 크게 두 가지로 볼 수 있는데요, 이 두가지는 
...
*Fig. PCA Visualization of trained Word2Vec Network*
...
*Fig. Bidirectional Encoder Representation from Transformer, BERT*
...
## <mark style='background-color: #dcffe4'> Contrastive Learning </mark>
