...
&
= p("(-,c,a,t)" \vert x ) + p("(c,-,a,t)" \vert x ) + p("(c,c,a,t)" \vert x ) + p("(c,a,-,t)" \vert x ) + p("(c,a,a,t)" \vert x ) + p("(c,a,t,-)" \vert x ) + p("(c,a,t,t)" \vert x )
& \\
\end{aligned}
$$
...
\begin{aligned}  
&
p("cat" \vert x) = p("(-,c,a,t)" \vert x ) + p("(c,-,a,t)" \vert x ) + p("(c,c,a,t)" \vert x ) + p("(c,a,-,t)" \vert x ) + p("(c,a,a,t)" \vert x ) + p("(c,a,t,-)" \vert x ) + p("(c,a,t,t)" \vert x )
& \\
  
&
= \prod_{t=1}^T y_{{"(-,c,a,t)"}__t}^t + \prod_{t=1}^T y_{{"(c,-,a,t)"}_t}^t + \prod_{t=1}^T y_{{"(c,c,a,t)"}_t}^t + \prod_{t=1}^T y_{{"(c,a,-,t)"}_t}^t + \prod_{t=1}^T y_{{"(c,a,a,t)"}_t}^t + \prod_{t=1}^T y_{{"(c,a,t,-)"}_t}^t + \prod_{t=1}^T y_{{"(c,a,t,t)"}_t}^t
& \\ 
\end{aligned}
$$
