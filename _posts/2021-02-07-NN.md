...
CS231n이나 Andrew Ng의 coursera lecture 같은 기초 강의에도 잘 설명이 되어있는 내용이기 때문에 (모두 딥러닝 뉴비때는 '응'선생 하곤 하죠.) 
...
이번 글을 통해서 Black Box라고 하는 딥러닝 기법의 Neural Network가 실제로는 어떤 일을 하는지 조금 감이 오셨으면 좋겠습니다.
