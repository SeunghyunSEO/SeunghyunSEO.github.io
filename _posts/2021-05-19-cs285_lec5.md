...
&
\bigtriangledown_{\theta} J(\theta) \approx \frac{1}{N} \sum_{i=1}^N \bigtriangledown_{\theta} log p_{\theta} (\gamma) r(\gamma)
& \\

&
\bigtriangledown_{\theta} J(\theta) \approx \frac{1}{N} \sum_{i=1}^N \bigtriangledown_{\theta} log p_{\theta} (\gamma) [ r(\gamma) - b ]
& \\
 
&
\text{where } b = \frac{1}{N} \sum_{i=1}^N r(\gamma)
& \\
\end{aligned}
$$
