...
![nondiff_example](/assets/images/CS285/lec-4/nondiff_example.png)
*Additive Fig.*
...
- <center> $$\mathbb{E}_{\pi_{\theta}}[r(x)]$$ smooth in $$\theta$$ </center>

신기하게도 연속적이게 되고, 이는 미분 가능합니다.

- <center> $$\mathbb{E}_{\pi_{\theta}}[r(x)]$$ = \theta (+1) + (1-\theta)(-1) </center>
