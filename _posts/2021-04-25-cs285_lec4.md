...
*Additive. Fig. [A non-exhaustive, but useful taxonomy of algorithms in modern RL.](https://spinningup.openai.com/en/latest/index.html). 강화 학습 알고리즘은 크게 Model-Free RL, Model-based RL로 나눌 수 있다.*
