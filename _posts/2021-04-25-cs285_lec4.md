...
이는 Expectation을 반복해서 (recursively) 쓰면 아래와 같이 다시 아래 처럼 쓸 수 있습니다.

$$
\mathbb{E}_{s_1 \sim p(s_1)} [ \mathbb{E}_{a_1 \sim \pi(a_1 \vert s_1} r(s_1,a_1) + \qquad \qquad \qquad \qquad \qquad \qquad \vert s_1 ]
$$

$$
\mathbb{E}_{s_1 \sim p(s_1)} [ \mathbb{E}_{a_1 \sim \pi(a_1 \vert s_1} r(s_1,a_1) + \mathbb{E}_{s_2 \sim p(s2 \vert s1,a1}[ \qquad \qquad \qquad \vert s_1,a_1] \vert s_1 ]
$$
