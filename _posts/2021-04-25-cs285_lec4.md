...
- $$a_1$$ : 그 state들에 대한 action distribution $$\pi(a_1|s_1)$$에 대한 기대값 (policy로부터)
- $$s_2$$ : state-action distribution $$p(s_2 \vert s_1,a_1)$$에 대한 기대값 
- $$a_2$$ : action distribution $$\pi(a_2|s_2)$$에 대한 기대값 (policy로부터)

$$\vdots$$ 

- $$s_T$$ : state-action distribution $$p(s_T \vert s_{T-1},a_{T-1})$$에 대한 기대값 
- $$a_T$$ : action distribution $$\pi(a_T|s_T)$$에 대한 기대값 (policy로부터)
