...
<center>$$=argmax_\theta[\prod_{i=1}^{I}Pr(x_{i}\mid\theta)]$$<\center>
 
우리는 가우시안 분포의 파라메터인 평균,분산을 찾고 싶으므로 다음과 같이 바꿔 쓸 수 있습니다.

<center>$$Pr(x_{1...I}\mid\theta) = Pr(x_{1...I}\mid\mu,\sigma )$$<\center>
 <center>$$=argmax_\theta[\prod_{i=1}^{I}Pr(x_{i}\mid\mu,\sigma)]$$<\center>
